...
# định nghĩa helper() để return ra 1 dict trong đó chưa kí tự và số lần xuất hiện. Làm đầu vào cho 2 function print_words() và print_top()
...
def print_words(filename):
    print(helper(filename))


def print_top(filename):
    new_dict = Counter(helper(filename))
    new_dict.most_common()
    for k, v in new_dict.most_common(20):
        print(k, v)
